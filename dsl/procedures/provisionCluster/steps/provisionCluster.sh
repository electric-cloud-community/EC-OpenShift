...
ansible-playbook -vvvv $COMMANDER_WORKSPACE/ansible/openshift-ansible/playbooks/byo/config.yml -i $COMMANDER_WORKSPACE/hosts -M $COMMANDER_WORKSPACE/ansible/openshift-ansible/library