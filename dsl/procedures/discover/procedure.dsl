...
procedure 'Discover',
	description: '''<html>Automatically create microservice models in ElectricFlow for the services and the pods discovered within a project on a OpenShift cluster.
<div>
    <ol>
    ...
    property 'stepPickerDescription',
        value: 'Automatically create microservice models in ElectricFlow for the services and the pods discovered within a project on a OpenShift cluster.'
