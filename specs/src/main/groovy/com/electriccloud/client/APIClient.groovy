...
class APIClient extends HttpClient {
    ...
    def login(username, password) {
        ...
        request(baseUri,"sessions", Method.POST, null, defaultHeaders(), query, true)
    }
    ...
    def dsl(dslText, params) {
        ...
        request(baseUri,"server/dsl?dsl=${encode(dslText)}${_params}", Method.POST, null, defaultHeaders(), null, false)
    }
    ...
    def getJobStatus(jobId) {
        request(baseUri,"jobs/$jobId?request=getJobStatus", Method.GET, null , defaultHeaders(), null, false)
    }

    def getJobDetails(jobId) {
        request(baseUri,"jobs/$jobId?request=getJobDetails", Method.GET, null , defaultHeaders(), null, false)
    }

    def getJobSummary(jobId) {
        request(baseUri,"jobs/$jobId?request=getJobSummary", Method.GET, null , defaultHeaders(), null, false)
    }
    ...
    def deleteProject(projectName) {
        ...
        request(baseUri, "projects/$projectName", Method.DELETE, null, defaultHeaders(), null, false)
    ...
    def createCredential(projectName, cred){
        ...
        request(baseUri, uri , Method.POST, null, defaultHeaders(), null , false)
    ...
    def deleteCredential(projectName, credName){
        ...
        request(baseUri, uri , Method.DELETE, null, defaultHeaders(), null , false)
    ...
    def deleteArtifact(artifactName){
        ...
        request(baseUri, "artifacts/${artifactName}", Method.DELETE, null, defaultHeaders(), null, false)
    ...
    def deleteService(projectName, serviceName) {
        ...
        request(baseUri, "projects/${projectName}/services/${serviceName}", Method.DELETE, null, defaultHeaders(), null, false)
    ...
    def getService(projectName, serviceName) {
        ...
        def response = request(baseUri, "projects/${projectName}/services/${serviceName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getServices(projectName) {
        ...
        def response = request(baseUri, "projects/${projectName}/services", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getApplicationServices(projectName, applicationName) {
        message('getting services')
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/services?applicationName=${applicationName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getServiceContainer(projectName, serviceName, containerName){
        ...
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/containers/${containerName}?serviceName=${serviceName}&includeDetails=true", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getServiceContainers(projectName, serviceName, withDetails){
        ...
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/services/${serviceName}/containers?includeDetails=true", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def deleteApplication(projectName, applicationName) {
        ...
        request(baseUri, "projects/${projectName}/applications/${applicationName}", Method.DELETE, null, defaultHeaders(), null, true)
    ...
    def getApplication(projectName, applicationName) {
        ...
        def response = request(baseUri, "projects/${projectName}/applications/${applicationName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getApplications(projectName) {
        ...
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/applications", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getApplicationService(projectName, applicationName, serviceName){
        ...
        def response = request(baseUri, "projects/${projectName}/applications/${applicationName}/services/${serviceName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getApplicationContainer(projectName, applicationName, serviceName, containerName){
        message('getting container')
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/applications/${applicationName}/services/${serviceName}/containers/${containerName}?includeDetails=true", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getApplicationContainers(projectName, applicationName, serviceName){
        message('getting containers')
        log.info("Got Services from project: ${projectName}")
        def response = request(baseUri, "projects/${projectName}/applications/${applicationName}/services/${serviceName}/containers?includeDetails=true", Method.GET, null, defaultHeaders(), null, true)
        response
    }

    def tierMappings(projectName, applicationName){
        def response = request(baseUri, "projects/${projectName}/applications/${applicationName}/tierMaps", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def deleteEnvironment(projectName, environmentName) {
        ...
        def response = request(baseUri, "projects/${projectName}/environments/${environmentName}", Method.DELETE, null, defaultHeaders(), null, false)
    ...
    def getEnvironment(projectName, environmentName) {
        ...
        def response = request(baseUri, "projects/${projectName}/environments/${environmentName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getEnvironments(environmentName) {
        ...
        def response = request(baseUri, "projects/${environmentName}/environments", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getEnvCluster(projectName, environmentName, clusterName){
        ...
        def response = request(baseUri, "projects/${projectName}/clusters/${clusterName}?environmentName=${environmentName}", Method.GET, null, defaultHeaders(), null, true)
        response
    }
    ...
    def getJobSteps(jobId){
        message('job steps')
        def resp = request(baseUri, "jobSteps?request=findJobSteps&jobId=${jobId}", Method.GET, null, defaultHeaders(), null, true)
        resp
    }
    ...
    def getArtifactVersions(artifactName){
        def resp = request(baseUri, "artifactVersions?artifactName=$artifactName", Method.GET, null, defaultHeaders(), null, true)
        resp
    }
