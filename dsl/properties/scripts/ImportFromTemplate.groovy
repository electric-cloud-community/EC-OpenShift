...
public class ImportFromTemplate extends EFClient {
    ...
    def importFromTemplate(namespace, fileYAML){
        ...
        logger INFO, "PARSED CONFIG LIST BEGIN: ${prettyPrint(parsedConfigList)}"
        ...
        logger INFO, "Parsed services: ${prettyPrint(services)}"
        ...
        logger INFO, "Parsed deployments: ${prettyPrint(deployments)}"
    ...
    def getParsedServices(parsedConfigList){
        ...
        logger DEBUG, "parsedConfigList VALUE ${prettyPrint(services)}"
    }
